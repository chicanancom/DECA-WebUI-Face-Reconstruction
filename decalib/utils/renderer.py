...
def set_rasterizer(type = 'pytorch3d'):
    if type == 'pytorch3d':
        ...
        # Check for compiler before trying to load
        if shutil.which('cl') is None:
            raise RuntimeError("C++ compiler (cl.exe) not found. Please install Visual Studio Build Tools if you need the standard rasterizer visualization. Skipping renderer setup.")
